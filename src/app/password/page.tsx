...
export default function PasswordGenerator() {
  ...
  return (
    <div className="max-w-3xl mx-auto opacity-100 transition-opacity duration-500">
      {/* 头部 */}
      <div className="mb-8">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">强密码生成器</h1>
        </div>
        <p className="text-slate-500">本地生成高强度随机密码，支持自定义规则，安全可靠。</p>
      </div>
